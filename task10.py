...
def check_price_style_regular(regular_price_color, regular_price_style, page):
    if regular_price_color == "rgba(119, 119, 119, 1)" and regular_price_style == 's':
...
def check_price_style_campaign(campaign_price_color, campaign_price_style, page):
    if campaign_price_color == "rgba(204, 0, 0, 1)" and campaign_price_style == 'strong':
...
def func():
    try:
        ...
        check_price_style_regular(regular_price_color, regular_price_style, page)
        check_price_style_campaign(campaign_price_color, campaign_price_style, page)
        ...
        check_price_style_regular(regular_price_color_inner, regular_price_style_inner, page)
        check_price_style_campaign(campaign_price_color_inner, campaign_price_style_inner, page)
